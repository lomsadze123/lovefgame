...
export function SliderButton() {
  ...
  return (
    <div className="fixed top-0 left-0 z-10 flex h-dvh flex-col items-center justify-center">
      <button className="group ml-11 hidden h-14 w-14 cursor-pointer items-center justify-center rounded-full border-2 transition-colors duration-500 ease-in-out xl:flex xl:hover:bg-foreground">
